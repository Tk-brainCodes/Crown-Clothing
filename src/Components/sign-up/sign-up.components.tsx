...
const SignUp = () => {
    ...
    const handleDisplayName = (e: React.ChangeEvent<HTMLInputElement>) : void => setDisplayName(e.target.value)
    ...
    const handleConfirmPassword = (e: React.ChangeEvent<HTMLInputElement>) : void => setConfirmPassword(e.target.value)
